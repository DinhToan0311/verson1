...
<html lang="en">
  ...
  width: 50%;
  height: 100%;
  background: url(../img/doraemon/2.jpg) no-repeat center;
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <img src="../img/doraemon/2.jpg" alt="" class="cover" />
        ...
        <div class="about">
          ...
          <div class="topic">Doraemon</div>
          <div class="des">
            Nội dung series kể về cuộc đời của cậu bé Nobita và chú mèo máy Doraemon từ tương lai
             đến để giúp cuộc sống của cậu bé trở nên tốt hơn. Tác phẩm ba lần được chuyển thể 
             thành anime: lần đầu do Nippon TV Dōga sản xuất gồm 52 tập phát sóng trên Nippon TV
          </div>
          <div class="imdb">
          ...
          <div class="buttons">
            <?php if ($loggedIn): ?>
              <a href="../fiml/watch_series.php?id=16" class="action-btn">Xem ngay</a>
            <?php else: ?>
