...
<html lang="en">
  <head>
    ...
    <title>Thanh Gươm Diệt Qủy</title>
  ...
  width: 50%;
  height: 100%;
  background: url(../img/maruko/3.jpg) no-repeat center;
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <img src="../img/maruko/3.jpg" alt="" class="cover" />
        ...
        <div class="about">
          ...
          <div class="topic">Nhóc MaRuKo</div>
          <div class="des">
           Chibi Maruko-chan là một loạt shōjo manga của nữ tác giả 
           Sakura Momoko, sau đó được chuyển thể sang anime TV bởi hãng hoạt hình Nippon Animation, phát sóng trên Fuji ..
          </div>
          <div class="imdb">
          ...
          <div class="buttons">
            <?php if ($loggedIn): ?>
              <a href="../fiml/watch_series.php?id=17" class="action-btn">Xem ngay</a>
            <?php else: ?>
