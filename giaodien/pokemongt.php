...
<html lang="en">
  ...
  width: 50%;
  height: 100%;
  background: url(../img/pokemon/1.jpg) no-repeat center;
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <img src="../img/pokemon/1.jpg" alt="" class="cover" />
        ...
        <div class="about">
          ...
          <div class="des">
           Các sinh vật hư cấu gọi là "Pokémon", mà con người, được gọi là
            Pokémon Trainers ,
             bắt và huấn luyện để chiến đấu với nhau để chơi thể thao. Khẩu hiệu tiếng Anh cho nhượng 
          ...
          <div class="imdb">
           ...
           <div class="buttons">
            <?php if ($loggedIn): ?>
              <a href="../fiml/watch_series.php?id=29" class="action-btn">Xem ngay</a>
            <?php else: ?>
