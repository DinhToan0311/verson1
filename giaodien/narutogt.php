...
<html lang="en">
  ...
  width: 50%;
  height: 100%;
  background: url(../img/naruto/1.jpg) no-repeat center;
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <img src="../img/naruto/1.jpg" alt="" class="cover" />
        ...
        <div class="about">
          ...
          <div class="buttons">
            <?php if ($loggedIn): ?>
              <a href="../fiml/watch_series.php?id=15" class="action-btn">Xem ngay</a>
            <?php else: ?>
