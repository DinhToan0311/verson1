...
<html lang="en">
  ...
  width: 50%;
  height: 100%;
  background: url(../img/thanhguomdietquy/1.jpg) no-repeat center;
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <img src="../img/thanhguomdietquy/1.jpg" alt="" class="cover" />
        ...
        <div class="about">
          ...
          <div class="topic">Thanh Gươm Diệt Qủy</div>
          <div class="des">
           Phim anime bởi Haruo Sotozaki từ Nhật Bản; phim điện ảnh hoạt hình năm 2025 được đạo diễn bởi Sotozaki Haruo
          </div>
          <div class="imdb">
           ...
           <div class="buttons">
            <?php if ($loggedIn): ?>
              <a href="../fiml/watch_series.php?id=30" class="action-btn">Xem ngay</a>
            <?php else: ?>
