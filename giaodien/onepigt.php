...
<html lang="en">
  ...
  width: 50%;
  height: 100%;
  background: url(../img/onepi/3.jpg) no-repeat center;
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <img src="../img/onepi/3.jpg" alt="" class="cover" />
        ...
        <div class="about">
          ...
          <div class="topic">Onepi</div>
          <div class="des">
            Thế giới của One Piece có con người và các chủng tộc khác như người lùn 
            (có kích thước gần giống tiên), người khổng lồ, merfolk, người cá, bộ lạc chân dài, người cổ dài được gọi 
            là bộ lạc Snakeneck và người động vật (được gọi là "Minks"). Thế giới được quản lý bởi một tổ chức liên lục địa 
            được gọi là Chính Phủ Thế Giới, bao gồm hàng chục quốc gia thành viên.
          </div>
          <div class="imdb">
          ...
          <div class="buttons">
            <?php if ($loggedIn): ?>
              <a href="../fiml/watch_series.php?id=28" class="action-btn">Xem ngay</a>
            <?php else: ?>
