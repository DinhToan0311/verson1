...
<body>
  <div class="container">
    ...
    <div class="content">
      <img src="../img/attackontitan/1.jpg" alt="" class="cover" />
      ...
      <div class="about">
        ...
        <div class="topic">Attack On TiTan</div>
        <div class="des">
          loạt manga bởi Hajime Isayama từ Shōnen Magazine Comics,
          Kodansha Comics, Elex Media Komputindo, Nhà xuất bản Đông Lập,
          và Norma Editorial từ Nhật Bản; loạt manga năm 2009 của Isayama Hajime
        </div>
        <div class="imdb">
        ...
        <div class="buttons">
          <?php if ($loggedIn): ?>
            <a href="../fiml/watch_series.php?id=21" class="action-btn">Xem ngay</a>
          <?php else: ?>
